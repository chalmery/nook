...
public class DiscoverDetailView extends BorderPane {
    ...
    public DiscoverDetailView() {
        ...
        imagePane.setPrefSize(160, 160);
        imagePane.setMinSize(160, 160);
        imagePane.setMaxSize(160, 160);
        ...
        VBox infoBox = new VBox(8, titleLabel, authorLabel, descLabel, actions);
    ...
    public void setPodcast(Podcast podcast) {
        ...
        if (desc != null && !desc.isBlank()) {
            descLabel.setText(desc.length() > 300 ? desc.substring(0, 300) + "..." : desc);
